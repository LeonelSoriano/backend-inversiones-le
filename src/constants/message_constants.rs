...
pub const MESSAGE_EMAIL_EXIST: &str = "invalid email, already exist";

pub const MESSAGE_USERNAME_EXIST: &str = "invalid username, already exist";
pub const MESSAGE_USER_NOT_EXIST: &str = "user not found";

pub const MESSAGE_IMG_CANT_SAVE: &str = "img cant save";
